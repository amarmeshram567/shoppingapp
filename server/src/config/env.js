...
export const env = {
  ...
  clientUrl: process.env.CLIENT_URL || "https://shoppingapp-hdvu.vercel.app",
  clientUrls: (process.env.CLIENT_URLS || process.env.CLIENT_URL || "https://shoppingapp-hdvu.vercel.app")
    .split(",")
